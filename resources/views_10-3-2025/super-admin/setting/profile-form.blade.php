<x-layout.default>
    <div
        ...
        <div>
            <form action="{{ route('super-admin.profile.update') }}" method="POST" enctype="multipart/form-data" class="border border-[#ebedf2] dark:border-[#191e3a] rounded-md p-4 mb-5 bg-white dark:bg-[#0e1726]">
                @csrf
                        ...
                        <div class="flex-1 grid grid-cols-1 sm:grid-cols-2 gap-5">
                            ...
                            <div>
                                ...
                                <input id="phone" type="text" name="contact" placeholder="+1 (530) 555-12121"
                                    class="form-input" required value="{{ $profile->contact ?? '' }}" />
                            </div>
                            <div>
