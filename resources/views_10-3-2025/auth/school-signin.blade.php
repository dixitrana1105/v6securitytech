                        ...
                        <form id="loginForm" class="space-y-5 dark:text-white" method="POST" action="{{ route('school-admin.login') }}">
                            ...
                            <div class="relative text-white-dark">
                                <select id="redirectUrl" name="redirect_url" class="w-full p-2 border border-gray-300 rounded-md" onchange="updateFormAction()">
                                    ...
                                    {{-- <option value="security">School Security</option> --}}
                                </select>
                            </div>
                            ...
                            onclick="window.location.href='/school/security/new-signin'">
                            School Security Sign In
                    </button> --}}
                        </form>
...
<script>
    function updateFormAction() {
        ...
        if (selectedValue === 'school') {
            form.action = '/school/login';  // Building specific URL
        } else if (selectedValue === 'security') {
            form.action = '/school/security/login';  // Security specific URL
        }
    }
</script>
