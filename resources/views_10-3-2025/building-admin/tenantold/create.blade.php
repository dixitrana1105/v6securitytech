    ...
    <div class="panel shadow-lg rounded-lg p-8 max-w-6xl mx-auto " style="border-color: #a8acaf; border-width: medium;">
        ...
        <div class="flex justify-between items-center">
            ...
            <div>
                ...
                <input id="registerDate" type="date" style="width: 100%" class="form-input" required/>
            </div>
        </div>
        <br>
            <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                <div>
                    ...
                    <input id="tenantId" type="text" name="tenantId" placeholder="Auto Generate" class="form-input" required/>
                </div>
                <div>
