        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 xl:grid-cols-1 gap-5 mb-5">
            <div class="panel shadow-lg rounded-lg p-8 max-w-6xl mx-auto"
                ...
                <div class="flex items-center justify-between mb-5">
                    ...
                    <a href="/building-admin/profile-form" class="ltr:ml-auto rtl:mr-auto btn btn-primary p-2 rounded-full">
                ...
                <div class="mb-5">
                    {{-- <div class="flex flex-col justify-center items-center">
                        <img src="/assets/images/logo.svg" alt="image" class="w-24 h-24 rounded-full object-cover mb-5" />
                    </div> --}}
                    <div class="mb-5">
