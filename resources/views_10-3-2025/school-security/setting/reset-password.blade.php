            ...
            <div class="relative flex w-full max-w-[1502px] flex-col justify-between overflow-hidden rounded-md bg-white/60 backdrop-blur-lg dark:bg-black/50 lg:min-h-[758px] lg:flex-row lg:gap-10 xl:gap-0">
                ...
                <div class="relative flex w-full flex-col items-center justify-center gap-6 px-4 pb-16 pt-6 sm:px-6 lg:max-w-[667px]">
                    ...
                    <div class="w-full max-w-[440px] lg:mt-16">
                        ...
                        <form method="POST" action="{{ route('school-security.update_password') }}">
                            @csrf <!-- CSRF token for security -->
                            <div class="flex flex-col gap-2 mb-4">

                                <label for="oldpsw" class="mb-1">Old Password</label>
                                <input id="oldpsw" name="old_password" type="password" placeholder="Enter old password" class="form-input pl-10 placeholder:text-white-dark" required />
                                @error('old_password')
                            ...
                            <div class="flex flex-col gap-2 mb-4">
                                ...
                                <input id="newpsw" name="password" type="password" placeholder="Enter new password" class="form-input pl-10 placeholder:text-white-dark" required/>
                                @error('password')
                                    <span class="text-red-600">{{ $message }}</span>
                                @enderror
                            </div>
                            ...
                            <div class="flex flex-col gap-2 mb-4">
                                ...
                                <input id="confpsw" name="password_confirmation" type="password" placeholder="Enter confirm password" class="form-input pl-10 placeholder:text-white-dark" required/>
                            </div>
