    ...
    <div class="relative flex min-h-screen items-center justify-center bg-[url(/assets/images/auth/map.png)] bg-cover bg-center bg-no-repeat px-6 py-10 dark:bg-[#060818] sm:px-16">
        <div class="pt-5">
            <div class="grid grid-cols-1 lg:grid-cols-3 xl:grid-cols-1 gap-5 mb-5">
                <div class="panel shadow-lg rounded-lg p-8 max-w-6xl mx-auto " style="border-color: #a8acaf; border-width: medium; width: 880px;">
                    <div class="flex items-center justify-between mb-5">
                        <h5 class="font-semibold text-lg dark:text-white-light">Company Profile</h5>
                        <a href="/school-admin/setting/profile-form"
                        ...
                        <div class="grid grid-cols-2 gap-6 mb-5">
                            <div class="flex flex-col justify-center items-center">
                                <ul class="mt-5 flex flex-col max-w-[200px] m-auto space-y-4 font-semibold text-white-dark">
                                    ...
                                    <li class="flex items-center gap-2">
                                        <div class="flex gap-1">
                                        <label for="address_1"><strong>Address 2:-</strong></label>
                                        <span>Surat</span>
                                        </div>    
                            ...
                            <div class="flex flex-col justify-center items-center">
                                <ul class="mt-5 flex flex-col max-w-[160px] m-auto space-y-4 font-semibold text-white-dark">
                                    <li class="flex items-left gap-2">
                                        <div class="flex gap-1">                                        
                                        <label for="personname"><strong>Name:-</strong></label>
                                        <span>Web Developer</span>
                                        </div>
                                    </li>
                                    <li>
                                        ...
                                        <span class="text-primary truncate">jimmy@gmail.com</span>
                                        </div>
                                    </li>
                                    <li class="flex items-center gap-2">
                                        <div class="flex gap-1">                                   
