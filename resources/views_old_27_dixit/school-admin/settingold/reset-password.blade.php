                    ...
                    <div class="w-full max-w-[440px] lg:mt-16">
                        ...
                        <form>
                            <div class="flex flex-col gap-2 mb-4">
                                ...
                                <input id="oldpsw" type="password" placeholder="Enter old password" class="form-input pl-10 placeholder:text-white-dark" required />
                            </div>
                            
                            <div class="flex flex-col gap-2 mb-4">
                                <label for="newpsw" class="mb-1">New Password</label>
                                <input id="newpsw" type="password" placeholder="Enter new password" class="form-input pl-10 placeholder:text-white-dark" required/>
                            </div>
                            
                            <div class="flex flex-col gap-2 mb-4">
                                <label for="confpsw" class="mb-1">Confirm Password</label>
                                <input id="confpsw" type="password" placeholder="Enter confirm password" class="form-input pl-10 placeholder:text-white-dark" required/>
                            </div>
