<x-layout.default>
    <div
        ...
        <div>
            <form action="{{ route('school-admin.profile.update') }}" method="POST" enctype="multipart/form-data" class="border border-[#ebedf2] dark:border-[#191e3a] rounded-md p-4 mb-5 bg-white dark:bg-[#0e1726]">
                @csrf
