<x-layout.default>
    <div
        ...
        <div>
            <form action="{{ route('school-security.profile.update') }}" method="POST" enctype="multipart/form-data" class="border border-[#ebedf2] dark:border-[#191e3a] rounded-md p-4 mb-5 bg-white dark:bg-[#0e1726]">
                @csrf
                        ...
                        <div class="flex-1 grid grid-cols-1 sm:grid-cols-2 gap-5">
                            ...
                            <div>
                                ...
                                <input id="name" type="text" name="name" placeholder="name"
                                    class="form-input" required value="{{ $profile->name ?? '' }}" />
                            </div>
                            <div>
                                <label for="phone">Contact Number</label>
                                <input id="phone" type="text" name="contact" placeholder="+1 (530) 555-12121"
                                    class="form-input" required value="{{ $profile->contant_number ?? '' }}" />
                            </div>
                            <div>
                            ...
                            <div>
                                ...
                                <input id="address" type="text" name="address_1" placeholder="New York"
                                    class="form-input" required value="{{ $profile->c_address_1 ?? '' }}" />
                            </div>
                            <div>
                                <label for="address_1">Address 2</label>
                                <input id="address_1" type="text" name="address_2" placeholder="New York"
                                    class="form-input" required value="{{ $profile->c_address_2 ?? '' }}" />
                            </div>
                            <div>
