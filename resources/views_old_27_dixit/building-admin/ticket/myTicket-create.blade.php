<x-layout.default>
    <div
        ...
        <div class="panel shadow-lg rounded-lg p-8 max-w-6xl mx-auto "
            ...
            <form action="{{ route('building-admin.myTicket-store') }}" method="POST" enctype="multipart/form-data">
                @csrf
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                    ...
                    <div>
                        ...
                        <select id="role" name="role" class="form-select" required>
                            ...
                            <option value="building_security">Building Security</option>
                            <option value="building_tenant">Building User</option>
                        </select>
                    </div>
