        ...
        <form>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                ...
                <div>
                    ...
                    <input id="city" name="city" type="text" placeholder="Enter City" class="form-input" required />
                </div>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                <div>
                    ...
                    <input id="country" name="country" type="text" placeholder="Enter Country" class="form-input" required />
                </div>
                <div>
                    <label for="state"><strong>State</strong></label>
                    <input id="state" name="state" type="text" placeholder="Enter State" class="form-input" required />
                </div>
            </div>
            <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                <div>
                    <label for="permanent_city"><strong>City</strong></label>
                    <input id="permanent_city" name="permanent_city" type="text" placeholder="Enter City" class="form-input" required />
                </div>
            </div>
