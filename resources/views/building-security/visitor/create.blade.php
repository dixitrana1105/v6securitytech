<x-layout.default>
    <div
        ...
        <div class="panel shadow-lg rounded-lg p-8 max-w-6xl mx-auto "
            ...
            <form action="{{ route('building-security.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                    ...
                    <div>
                        ...
                        <input id="date" name="date"  placeholder="Enter Date" class="form-input" readonly required />
                    </div>
                    {{-- <!--<div>-->
                    <!--    <label for="card_id"><strong>Card</strong></label>-->
                    <!--    <select id="card_id" name="card_id" class="form-input" required>-->
                ...
                <div>
                    ...
                    <input id="mobile" name="mobile" type="number"  placeholder="Enter mobile number" class="form-input" required />
                </div>

                <div>
                    <label for="whatsapp"><strong>WhatsApp Number</strong></label>
                    <input id="whatsapp" name="whatsapp" type="number"  placeholder="Enter WhatsApp number" class="form-input" required />
                </div>
                </div>
                <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                    <div>
                    ...
                    <div>
                        ...
                        <select id="tenant_flat_office_no" name="tenant_flat_office_no" class="form-input" required>
                            ...
                            @foreach ($tenants as $tenant)
                                <option value="{{ $tenant->flat_office_no }}---{{ $tenant->reader_id }}">{{ $tenant->flat_office_no }}</option>
                            @endforeach
                        </select>
                    </div>
