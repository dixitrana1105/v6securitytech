            ...
            <div class="pt-5">
                <div class="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-5 gap-6 mb-6 text-white">
                    ...
                    <div class="panel bg-gradient-to-r from-cyan-500 to-fuchsia-400">
                        <div class="flex justify-between">
                            <div class="ltr:mr-1 rtl:ml-1 text-md font-semibold">Total Cards</div>
                        </div>
                        <div class="flex items-center mt-5">
                            <div class="text-3xl font-bold ltr:mr-3 rtl:ml-3">{{ $total_cards }}</div>
                            {{-- <div class="badge bg-white/30">+ 2.35% </div> --}}
                        </div>
                    </div>
                    <div class="panel bg-gradient-to-r from-cyan-500 to-fuchsia-400">
                        <div class="flex justify-between">
                            <div class="ltr:mr-1 rtl:ml-1 text-md font-semibold">Available Cards</div>
                        </div>
                        <div class="flex items-center mt-5">
                            <div class="text-3xl font-bold ltr:mr-3 rtl:ml-3">{{ $unassigned_cards }}</div>
                            {{-- <div class="badge bg-white/30">+ 2.35% </div> --}}
                        </div>
                    </div>
                    <div class="panel bg-gradient-to-r from-cyan-500 to-fuchsia-400">
                        <div class="flex justify-between">
                            <div class="ltr:mr-1 rtl:ml-1 text-md font-semibold">Assigned Cards</div>
                        </div>
                        <div class="flex items-center mt-5">
                            <div class="text-3xl font-bold ltr:mr-3 rtl:ml-3">{{ $assigned_cards }}</div>
                            {{-- <div class="badge bg-white/30">+ 2.35% </div> --}}
                        </div>
                    </div>
                </div>
