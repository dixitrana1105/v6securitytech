<x-layout.default>
    ...
    <div class="table-responsive" x-data="form">
        <table class="min-w-full shadow-lg rounded-lg overflow-hidden">
            ...
            <tbody>
                @foreach ($get_all_ticket_new as $ticket)
                    <tr class="border-b duration-300">
                        ...
                        <td class="py-2 px-8">
                            <div class="w-40 h-40 mb-5 overflow-hidden">
                                <img src="{{ asset($ticket->attachment) }}" alt="image" class="w-full h-full object-cover" />
                            </div>
                        </td>
                        ...
                        <td>
                            <select class="status-dropdown" data-ticket-id="{{ $ticket->ticket_id }}">
                                ...
                                <option value="1" {{ $ticket->status_of_button == 1 ? 'selected' : '' }}>Hold
                                </option>
                                <option value="2" {{ $ticket->status_of_button == 2 ? 'selected' : '' }}>Close
                                </option>
                            </select>
                        </td>
                    </tr>
            ...
            <tbody>
                @foreach ($get_all_ticket_new_from_school as $ticket)
                    <tr class="border-b duration-300">
            ...
            <tbody>
                @foreach ($get_all_ticket_new_from_tenant as $ticket)
                    <tr class="border-b duration-300">
                        {{-- <td>{{ $loop->iteration }}</td> --}}
                        <td class="py-2 px-8">
                            <img src="{{ asset($ticket->attachment) }}" alt="image" class="object-cover mb-5" />
