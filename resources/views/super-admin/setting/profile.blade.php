            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 xl:grid-cols-1 gap-5 mb-5">
                <div class="panel shadow-lg rounded-lg p-8 max-w-6xl mx-auto "
                    ...
                    <div class="flex items-center justify-between mb-5">
                        ...
                        <a href="/super-admin/setting/profile-form"
                    ...
                    <div class="mb-5">
                        ...
                        <div class="flex flex-col justify-center items-center">
                            ...
                            <div class="grid grid-cols-2 gap-6 mb-5">
                                <div class="flex flex-col justify-center items-center">
                                    <ul
                                        class="mt-5 flex flex-col max-w-[200px] m-auto space-y-4 font-semibold text-white-dark">
                                    ...
                                    <ul
                                        ...
                                        <li>
                                            <div class="flex gap-1">
                                                ...
                                                <span style="
    padding-right: 12rem;
" class="text-primary truncate">{{ $profile->email }}</span>
                                            </div>
                                        </li>
                                        <li class="flex items-center gap-2">
                                            <div class="flex gap-1">
