            ...
            <ul class="perfect-scrollbar relative font-semibold space-y-0.5 h-[calc(100vh-80px)] overflow-y-auto overflow-x-hidden  p-4 py-0"
                ...
                <li class="menu nav-item">
                    ...
                    <ul x-cloak x-show="activeDropdown === 'reader'" x-collapse class="sub-menu text-gray-500">
                        <li>
                            <a href="/super-admin/reader-index">List</a>
                        </li>
                        <li>
                            <a href="/super-admin/reader-create">Add</a>
                        </li>
                    </ul>
                </li>
                ...
                <li class="menu nav-item">
                    <button type="button" class="nav-link group"
                        :class="{ 'active': activeDropdown === 'card' }"
                        @click="activeDropdown === 'card' ? activeDropdown = null : activeDropdown = 'card'">
                        <div class="flex items-center">
                        ...
                        <div class="rtl:rotate-180" :class="{ '!rotate-90': activeDropdown === 'card' }">
                            <svg width="16" height="16" viewBox="0 0 24 24" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                                <path d="M9 5L15 12L9 19" stroke="currentColor" stroke-width="1.5"
                                    stroke-linecap="round" stroke-linejoin="round" />
                    ...
                    <ul x-cloak x-show="activeDropdown === 'card'" x-collapse class="sub-menu text-gray-500">
                        <li>
                            <a href="/super-admin/card-index">List</a>
                        </li>
                        <li>
                            <a href="/super-admin/card-create">Add</a>
                        </li>
                    </ul>
                </li>
