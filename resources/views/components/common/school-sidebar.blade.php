        ...
        <div class="bg-white dark:bg-[#0e1726] h-full">
            ...
            <ul class="perfect-scrollbar relative font-semibold space-y-0.5 h-[calc(100vh-80px)] overflow-y-auto overflow-x-hidden  p-4 py-0"
                ...
                <li class="menu nav-item">
                    <a href="/school/dashboard" class="nav-link group">
                        ...
                        <li class="menu nav-item">
                            <button type="button" class="nav-link group"
                                ...
                                <div class="flex items-center">
                                    ...
                                    <span
                                        class="ltr:pl-3 rtl:pr-3 text-black dark:text-[#506690] dark:group-hover:text-white-dark">Students</span>
                                </div>
                            ...
                            <ul x-cloak x-show="activeDropdown === 'students'" x-collapse
                                class="sub-menu text-gray-500">
                                <li>
                                    <a href="/school/student/index">List</a>
                                </li>
                                <li>
                                    <a href="/school/student/create">Add</a>
                                </li>
                            </ul>
                        </li>
                        <li class="menu nav-item">
                            ...
                            <ul x-cloak x-show="activeDropdown === 'security'" x-collapse
                                class="sub-menu text-gray-500">
                                <li>
                                    <a href="/school/security/index">List</a>
                                </li>
                                <li>
                                    <a href="/school/security/create">Add</a>
                                </li>
                            </ul>
                        </li>
                    </ul>
                ...
                <li class="menu nav-item">
                    ...
                    <ul x-cloak x-show="activeDropdown === 'cards'" x-collapse class="sub-menu text-gray-500">
                        <li>
                            <a href="/school-admin/card-index">List</a>
                        </li>
                    </ul>
                </li>
                <li class="menu nav-item">
                    ...
                    <ul x-cloak x-show="activeDropdown === 'reader'" x-collapse class="sub-menu text-gray-500">
                        <li>
                            <a href="/school-admin/reader-index">List</a>
                        </li>
                    </ul>
                </li>
            ...
            <li class="menu nav-item">
                ...
                <ul x-cloak x-show="activeDropdown === 'elements'" x-collapse class="sub-menu text-gray-500">
                    <li>
                        <a href="/school-admin/visitor-log">List</a>
                    </li>
                </ul>
            </li>
                ...
                <li class="menu nav-item">
                    <a href="/school-admin/dashboard-ticket" class="nav-link group">
                        <div class="flex items-center">
                            <svg class="group-hover:!text-primary shrink-0" width="20" height="20" viewBox="0 0 24 24" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                                <path opacity="0.5"
                ...
                <li class="menu nav-item">
                    <button type="button" class="nav-link group"
                        :class="{ 'active': activeDropdown === 'myticket' }"
                        @click="activeDropdown === 'myticket' ? activeDropdown = null : activeDropdown = 'myticket'">
                        <div class="flex items-center">
                        ...
                        <div class="rtl:rotate-180" :class="{ '!rotate-90': activeDropdown === 'myticket' }">
                    ...
                    <ul x-cloak x-show="activeDropdown === 'myticket'" x-collapse
                        class="sub-menu text-gray-500">
                        <li>
                            <a href="/school-admin/my-ticket-index">List</a>
                        </li>
                        <li>
                            <a href="/school-admin/my-ticket-create">Add</a>
                        </li>
                    </ul>
                </li>
                <li class="menu nav-item">
                    <a href="/school-admin/new-ticket" class="nav-link group">
                        <div class="flex items-center">
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path opacity="0.5" d="M3.77772 18.3259C4.78661 19 6.19108 19 9 19L15 19C17.8089 19 19.2134 19 20.2223 18.3259C20.659 18.034 21.034 17.659 21.3259 17.2223C22 16.2134 22 14.8089 22 12C22 9.19107 22 7.78661 21.3259 6.77772C21.034 6.34096 20.659 5.96595 20.2223 5.67412C19.2134 5 17.8089 5 15 5H9C6.19108 5 4.78661 5 3.77772 5.67412C3.34096 5.96596 2.96596 6.34096 2.67412 6.77772C2 7.78661 2 9.19108 2 12C2 14.8089 2 16.2134 2.67412 17.2223C2.96596 17.659 3.34096 18.034 3.77772 18.3259Z" fill="currentColor"></path>
                                <path d="M5.5 15.75C5.08579 15.75 4.75 15.4142 4.75 15L4.75 9C4.75 8.58579 5.08579 8.25 5.5 8.25C5.91421 8.25 6.25 8.58579 6.25 9L6.25 15C6.25 15.4142 5.91421 15.75 5.5 15.75Z" fill="currentColor"></path>
                ...
                <li class="menu nav-item">
                    <a href="/school-admin/open-ticket" class="nav-link group">
                        <div class="flex items-center">
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path opacity="0.5" d="M3.77772 18.3259C4.78661 19 6.19108 19 9 19L15 19C17.8089 19 19.2134 19 20.2223 18.3259C20.659 18.034 21.034 17.659 21.3259 17.2223C22 16.2134 22 14.8089 22 12C22 9.19107 22 7.78661 21.3259 6.77772C21.034 6.34096 20.659 5.96595 20.2223 5.67412C19.2134 5 17.8089 5 15 5H9C6.19108 5 4.78661 5 3.77772 5.67412C3.34096 5.96596 2.96596 6.34096 2.67412 6.77772C2 7.78661 2 9.19108 2 12C2 14.8089 2 16.2134 2.67412 17.2223C2.96596 17.659 3.34096 18.034 3.77772 18.3259Z" fill="currentColor"></path>
                                <path d="M5.5 15.75C5.08579 15.75 4.75 15.4142 4.75 15L4.75 9C4.75 8.58579 5.08579 8.25 5.5 8.25C5.91421 8.25 6.25 8.58579 6.25 9L6.25 15C6.25 15.4142 5.91421 15.75 5.5 15.75Z" fill="currentColor"></path>
                ...
                <li class="menu nav-item">
                    <a href="/school-admin/hold-ticket" class="nav-link group">
                        <div class="flex items-center">
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path opacity="0.5" d="M3.77772 18.3259C4.78661 19 6.19108 19 9 19L15 19C17.8089 19 19.2134 19 20.2223 18.3259C20.659 18.034 21.034 17.659 21.3259 17.2223C22 16.2134 22 14.8089 22 12C22 9.19107 22 7.78661 21.3259 6.77772C21.034 6.34096 20.659 5.96595 20.2223 5.67412C19.2134 5 17.8089 5 15 5H9C6.19108 5 4.78661 5 3.77772 5.67412C3.34096 5.96596 2.96596 6.34096 2.67412 6.77772C2 7.78661 2 9.19108 2 12C2 14.8089 2 16.2134 2.67412 17.2223C2.96596 17.659 3.34096 18.034 3.77772 18.3259Z" fill="currentColor"></path>
                                <path d="M5.5 15.75C5.08579 15.75 4.75 15.4142 4.75 15L4.75 9C4.75 8.58579 5.08579 8.25 5.5 8.25C5.91421 8.25 6.25 8.58579 6.25 9L6.25 15C6.25 15.4142 5.91421 15.75 5.5 15.75Z" fill="currentColor"></path>
                ...
                <li class="menu nav-item">
                    <a href="/school-admin/close-ticket" class="nav-link group">
                        <div class="flex items-center">
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path opacity="0.5" d="M3.77772 18.3259C4.78661 19 6.19108 19 9 19L15 19C17.8089 19 19.2134 19 20.2223 18.3259C20.659 18.034 21.034 17.659 21.3259 17.2223C22 16.2134 22 14.8089 22 12C22 9.19107 22 7.78661 21.3259 6.77772C21.034 6.34096 20.659 5.96595 20.2223 5.67412C19.2134 5 17.8089 5 15 5H9C6.19108 5 4.78661 5 3.77772 5.67412C3.34096 5.96596 2.96596 6.34096 2.67412 6.77772C2 7.78661 2 9.19108 2 12C2 14.8089 2 16.2134 2.67412 17.2223C2.96596 17.659 3.34096 18.034 3.77772 18.3259Z" fill="currentColor"></path>
                                <path d="M5.5 15.75C5.08579 15.75 4.75 15.4142 4.75 15L4.75 9C4.75 8.58579 5.08579 8.25 5.5 8.25C5.91421 8.25 6.25 8.58579 6.25 9L6.25 15C6.25 15.4142 5.91421 15.75 5.5 15.75Z" fill="currentColor"></path>
                ...
                <li class="menu nav-item">
                    <a href="/school-admin/setting/email" class="nav-link group">
                        <div class="flex items-center">
                ...
                <li class="menu nav-item">
                    <a href="/school-admin/setting/profile" class="nav-link group">
                        <div class="flex items-center">
                ...
                <li class="menu nav-item">
                    <a href="/school-admin/setting/reset-password" class="nav-link group">
                        <div class="flex items-center">
