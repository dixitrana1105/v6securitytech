<div :class="{ 'dark text-white-dark': $store.app.semidark }">
    ...
    <nav x-data="sidebar"
        ...
        <div class="bg-white dark:bg-[#0e1726] h-full">
            ...
            <ul class="perfect-scrollbar relative font-semibold space-y-0.5 h-[calc(100vh-80px)] overflow-y-auto overflow-x-hidden  p-4 py-0"
                ...
                <li class="nav-item">
                    <ul>
                        <li class="menu nav-item">
                            <button type="button" class="nav-link group"
                                :class="{ 'active': activeDropdown === 'visitor-alerts' }"
                                @click="activeDropdown === 'visitor-alerts' ? activeDropdown = null : activeDropdown = 'visitor-alerts'">
                                <div class="flex items-center">
                                <?xml version="1.0" ?><svg fill="currentColor" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg"><defs><style>.cls-1{fill:none;}</style></defs><title/><g data-name="Layer 2" id="Layer_2"><path d="M16,29a4,4,0,0,1-4-4,1,1,0,0,1,1-1h6a1,1,0,0,1,1,1A4,4,0,0,1,16,29Zm-1.73-3a2,2,0,0,0,3.46,0Z"/><path d="M18,7H14a1,1,0,0,1-1-1,3,3,0,0,1,6,0A1,1,0,0,1,18,7ZM16,5h0Z"/><path d="M27,26H5a1,1,0,0,1-1-1,7,7,0,0,1,3-5.75V14a9,9,0,0,1,8.94-9h.11a9,9,0,0,1,9,9v5.25A7,7,0,0,1,28,25h0A1,1,0,0,1,27,26ZM6.1,24H25.9a5,5,0,0,0-2.4-3.33,1,1,0,0,1-.5-.87V14A7,7,0,1,0,9,14v5.8a1,1,0,0,1-.5.87A5,5,0,0,0,6.1,24Z"/></g><g id="frame"><rect class="cls-1" height="32" width="32"/></g></svg>
                                    <span
                                        class="ltr:pl-3 rtl:pr-3 text-black dark:text-[#506690] dark:group-hover:text-white-dark">Visitor Alerts</span>
                                        <p class="badge-test">{{ \App\Models\ReadersLog::where('comments', 'like', '%wrong location%')->where("is_read", 0)->count() }}</p>
                                </div>
                                <div class="rtl:rotate-180" :class="{ '!rotate-90': activeDropdown === 'visitor-alerts' }">
                            ...
                            <ul x-cloak x-show="activeDropdown === 'visitor-alerts'" x-collapse
                                class="sub-menu text-gray-500">
                                <li>
                                    <a href="/school/security/visitor/alerts">List</a>
                                </li>
                                {{-- <li>
                                    <a href="/school/security/visitor/create">Add</a>
                                </li> --}}
                ...
                <li class="menu nav-item">
                    ...
                    <ul x-cloak x-show="activeDropdown === 'cards'" x-collapse class="sub-menu text-gray-500">
                        <li>
                            <a href="/school/security/card-index">List</a>
                        </li>
                    </ul>
                </li>
            ...
            <li class="menu nav-item">
                <button type="button" class="nav-link group" :class="{ 'active': activeDropdown === 'card-history' }"
                ...
                <ul x-cloak x-show="activeDropdown === 'card-history'" x-collapse class="sub-menu text-gray-500">
                    <li>
                        <a href="/school/security/card-history">List</a>
                    </li>
                </ul>
            </li>
