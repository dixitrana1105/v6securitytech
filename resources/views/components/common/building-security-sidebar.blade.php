        ...
        <div class="bg-white dark:bg-[#0e1726] h-full">
            ...
            <ul class="perfect-scrollbar relative font-semibold space-y-0.5 h-[calc(100vh-80px)] overflow-y-auto overflow-x-hidden  p-4 py-0"
                ...
                <li class="menu nav-item">
                    <a href="/building-security/dashboard" class="nav-link group">
                    ...
                    <ul>
                        <li class="menu nav-item">
                            ...
                            <ul x-cloak x-show="activeDropdown === 'visitors'" x-collapse
                                ...
                                <li>
                                    <a href="/building-security/new-entry">New Entry</a>
                                </li>
                                <li>
                                    <a href="/building-security/visitor-index">List</a>
                                </li>
                                    <li>
                                    <a href="/building-security/tenant-add-visitor-index-for-visitor">PreApproval List</a>
                                </li>
                                {{-- <li>
                                    <a href="/building-security/visitor-create">Add</a>
                                </li> --}}
                            </ul>
                        </li>
                    </ul>
                ...
                <li class="menu nav-item">
                    <button type="button" class="nav-link group"
                        ...
                        <div class="flex items-center">
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 64 64" width="64"
                                ...
                                <rect x="16" y="16" width="32" height="32" stroke="black" stroke-width="2"
                                    fill="white" />
                                <!-- Roof -->
                                <polygon points="16,16 32,8 48,16" stroke="black" stroke-width="2" fill="white" />
                                <!-- Windows -->
                                <rect x="22" y="22" width="8" height="8" stroke="black" stroke-width="2"
                                    fill="white" />
                                <rect x="34" y="22" width="8" height="8" stroke="black" stroke-width="2"
                                    fill="white" />
                                <rect x="22" y="34" width="8" height="8" stroke="black" stroke-width="2"
                                    fill="white" />
                                <rect x="34" y="34" width="8" height="8" stroke="black" stroke-width="2"
                                    fill="white" />
                            </svg>
                    ...
                    <ul x-cloak x-show="activeDropdown === 'components'" x-collapse class="sub-menu text-gray-500">
                        <li>
                            <a href="/building-security/tenant-index">List</a>
                        </li>
                    </ul>
                </li>
                ...
                <li class="menu nav-item">
                    ...
                    <ul x-cloak x-show="activeDropdown === 'security'" x-collapse class="sub-menu text-gray-500">
                        <li>
                            <a href="/building-security/security-index">List</a>
                        </li>
                    </ul>
                </li>
                ...
                <li class="menu nav-item">
                    ...
                    <ul x-cloak x-show="activeDropdown === 'cards'" x-collapse class="sub-menu text-gray-500">
                        <li>
                            <a href="/building-security/card-index">List</a>
                        </li>
                    </ul>
                </li>
                ...
                <li class="menu nav-item">
                    ...
                    <ul x-cloak x-show="activeDropdown === 'subtanent'" x-collapse class="sub-menu text-gray-500">
                        <li>
                            <a href="/building-security/sub-tenant">List</a>
                        </li>
                    </ul>
                </li>
                ...
                <li class="menu nav-item">
                    ...
                    <ul x-cloak x-show="activeDropdown === 'elements'" x-collapse class="sub-menu text-gray-500">
                        <li>
                            <a href="/building-security/visitor-log">List</a>
                        </li>
                    </ul>
                </li>
                ...
                <li class="menu nav-item">
                    <button type="button" class="nav-link group"
                        :class="{ 'active': activeDropdown === 'card-history' }"
                        @click="activeDropdown === 'card-history' ? activeDropdown = null : activeDropdown = 'card-history'">
                        <div class="flex items-center">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 64 64" width="64"
                                height="64">
                                <!-- Book/Log outline -->
                            ...
                            <span
                                class="ltr:pl-3 rtl:pr-3 text-black dark:text-[#506690] dark:group-hover:text-white-dark">Today's Card History</span>
                        </div>
                        <div class="rtl:rotate-180" :class="{ '!rotate-90': activeDropdown === 'card-history' }">
                    ...
                    <ul x-cloak x-show="activeDropdown === 'card-history'" x-collapse class="sub-menu text-gray-500">
                        <li>
                            <a href="/building-security/card-history">List</a>
                        </li>
                    </ul>
                </li>
                ...
                <li class="menu nav-item">
                    <a href="/building-security/ticket-dashboard" class="nav-link group">
                        <div class="flex items-center">
                            <svg class="group-hover:!text-primary shrink-0" width="20" height="20"
                                viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path opacity="0.5"
                ...
                <li class="menu nav-item">
                    ...
                    <ul x-cloak x-show="activeDropdown === 'tickets'" x-collapse class="sub-menu text-gray-500">
                        <li>
                            <a href="/building-security/myTicket-index">List</a>
                        </li>
                        <li>
                            <a href="/building-security/myTicket-create">Add</a>
                        </li>
                    </ul>
                </li>
                <li class="menu nav-item">
                    <a href="/building-security/new-ticket" class="nav-link group">
                        <div class="flex items-center">
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                                <path opacity="0.5"
                ...
                <li class="menu nav-item">
                    <a href="/building-security/open-ticket" class="nav-link group">
                        <div class="flex items-center">
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                                <path opacity="0.5"
                ...
                <li class="menu nav-item">
                    <a href="/building-security/hold-ticket" class="nav-link group">
                        <div class="flex items-center">
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                                <path opacity="0.5"
                ...
                <li class="menu nav-item">
                    <a href="/building-security/close-ticket" class="nav-link group">
                        <div class="flex items-center">
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                                <path opacity="0.5"
                ...
                <li class="menu nav-item">
                    <a href="/building-security/profile" class="nav-link group">
                        <div class="flex items-center">
                ...
                <li class="menu nav-item">
                    <a href="/building-security/password-reset" class="nav-link group">
                        <div class="flex items-center">
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
