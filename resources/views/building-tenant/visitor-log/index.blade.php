<x-layout.default>
    ...
    <form method="GET" action="{{ route('building-tenant.visitor-log') }}" class="flex justify-start items-center mb-4 space-x-4">
    <!-- Tenant Filter -->
                                ...
                                <div class="fixed inset-0 bg-[black]/60 z-[999]  hidden" :class="open && '!block'">
                                    <div class="flex items-start justify-center min-h-screen px-4"
                                        ...
                                        <div x-show="open" x-transition x-transition.duration.300
                                            ...
                                            <div class="p-5">
                                                @include('building-tenant.visitor-log.previous-log')
                                            </div>
                                        </div>
                                    </div>
                                </div>
